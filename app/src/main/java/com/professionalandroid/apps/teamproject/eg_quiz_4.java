...
public class eg_quiz_4 extends AppCompatActivity {
    private ConstraintLayout layout1, layout2;
    private int score,count;
    private TextView scoreTextView;

    private static final String SHARED_PREFS_KEY = "quiz_score";
    private static final String SCORE_KEY = "score"+7; //점수저장 키 값
    private static final String COUNT_KEY = "count"+7; // 힌트 사용유무의 저장
    private static final int SCORE_DEFAULT = 25; // 얻을수 있는 최대 점수 값
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout1 = findViewById(R.id.eg_quiz4_frontLayout);  // 퀴즈 레이아웃의 초기화면 최대 받을 수 있는 값과 현재 받을 수 있는 값이 나옴
        layout2 = findViewById(R.id.eg_quiz4_backLayout); // 퀴즈 레이아웃의 두번째 화면으로 퀴즈 내용과 각종 버튼이 구현됨
        ...
        Button laterButton = findViewById(R.id.eg_4_nextTime); //나중에 풀기
        ...
        hintButton.setOnClickListener(v -> {
            ...
            builder.setMessage(getString(R.string.eg_quiz_2_4_hint));
        ...
        laterButton.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(eg_quiz_4.this, homeActivity.class);
    ...
    private void updateScoreText() {
        scoreTextView.setText(getString(R.string.score_format_2_4, score));
    }
}