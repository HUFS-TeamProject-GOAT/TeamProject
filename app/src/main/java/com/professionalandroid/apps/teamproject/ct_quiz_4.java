...
public class ct_quiz_4 extends AppCompatActivity {
    ...
    private static final String SCORE_KEY = "score"+3; //점수저장 키 값
    private static final String COUNT_KEY = "count"+3; // 힌트 사용유무의 저장
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ct_quiz4); //ct_quiz4의 레이아웃을 사용
        clickPlay = MediaPlayer.create(this, R.raw.click);

        scoreTextView = findViewById(R.id.scoreTextView);
        layout1 = findViewById(R.id.ct_quiz4_frontLayout); // 퀴즈 레이아웃의 초기화면 최대 받을 수 있는 값과 현재 받을 수 있는 값이 나옴
        layout2 = findViewById(R.id.ct_quiz4_backLayout); // 퀴즈 레이아웃의 두번째 화면으로 퀴즈 내용과 각종 버튼이 구현됨
        ...
        Button laterButton = findViewById(R.id.ct_4_nextTime); //나중에 풀기
