...
public class st_quiz_3 extends AppCompatActivity {
    ...
    private static final String SCORE_KEY = "score"+14; //점수저장 키 값
    private static final String COUNT_KEY = "count"+14; // 힌트 사용유무의 저장
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout1 = findViewById(R.id.st_quiz3_frontLayout);  // 퀴즈 레이아웃의 초기화면 최대 받을 수 있는 값과 현재 받을 수 있는 값이 나옴
        layout2 = findViewById(R.id.st_quiz3_backLayout); // 퀴즈 레이아웃의 두번째 화면으로 퀴즈 내용과 각종 버튼이 구현됨
        ...
        Button laterButton = findViewById(R.id.st_3_nextTime);//나중에 풀기
        ...
        laterButton.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(st_quiz_3.this, homeActivity.class);
