...
public class fd_quiz_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fd_quiz2);
        clickPlay = MediaPlayer.create(this, R.raw.click);

        scoreTextView = findViewById(R.id.scoreTextView);
        layout1 = findViewById(R.id.fd_quiz2_frontLayout);  // 퀴즈 레이아웃의 초기화면 최대 받을 수 있는 값과 현재 받을 수 있는 값이 나옴
        layout2 = findViewById(R.id.fd_quiz2_backLayout); // 퀴즈 레이아웃의 두번째 화면으로 퀴즈 내용과 각종 버튼이 구현됨
        answerEditText = findViewById(R.id.fd_2_answer);
        Button submitButton = findViewById(R.id.fd_2_submitButton);
        Button hintButton = findViewById(R.id.fd_2_hint);
        Button laterButton = findViewById(R.id.fd_2_nextTime); //나중에 풀기
        ...
        laterButton.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(fd_quiz_2.this, homeActivity.class);
    ...
    private void updateScoreText() {
        scoreTextView.setText(getString(R.string.score_format_3_2, score));
    }
}