...
public class fd_quiz_2 extends AppCompatActivity {
    ...
    private static final String SCORE_KEY = "score"+10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout1 = findViewById(R.id.fd_quiz2_frontLayout);
        layout2 = findViewById(R.id.fd_quiz2_backLayout);
        ...
        Button laterButton = findViewById(R.id.fd_2_nextTime);
        ...
        laterButton.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(fd_quiz_2.this, stHallActivity.class);
