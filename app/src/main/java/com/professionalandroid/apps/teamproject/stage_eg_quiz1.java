...
public class stage_eg_quiz1 extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        btn_okay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (myET.getText().toString().equals("3")){
                    Toast.makeText(stage_eg_quiz1.this, "정답", Toast.LENGTH_SHORT).show();
                    Toast.makeText(stage_eg_quiz1.this, "다음퀴즈로 이동합니다.", Toast.LENGTH_SHORT).show();
                    finish();
                }
                else{
                    Toast.makeText(stage_eg_quiz1.this, "오답", Toast.LENGTH_SHORT).show();
                }
        ...
        btn_hint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(stage_eg_quiz1.this,"점수 -??점 " , Toast.LENGTH_LONG).show();
            }
        });
